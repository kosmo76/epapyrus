...
from osblog.forms import forms
...
class ArticleCreateView(CreateView):
    ...
    template_name = 'osblog/article_add.html'
...
class GrouperCreateView(CreateView):
    model = get_model('osblog','Grouper')
    template_name = 'osblog/grouper_add.html'
...
class ArticleDeleteView(DeleteView):
    model = get_model('osblog', 'Article')
    template_name = 'osblog/article_delete.html'
...
def save_tag_content(sender, **kwargs):
    ...
    tag_item_model = get_model('osblog','PrimaryTagItem')
